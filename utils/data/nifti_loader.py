...
class NiftiFewShotDataset(Dataset):
    def __init__(self, data_root, id_file, is_train=True, image_size=256):
        """
        ...
        # FIXED 1: Added enumerate to get vol_idx
    ...
    def __getitem__(self, idx):
        ...
        # FIXED 2: Deleted the block that was overwriting slice_idx with random numbers here!
